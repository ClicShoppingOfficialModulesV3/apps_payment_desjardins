 ...
 */
  ...
  class order_status_id extends \ClicShopping\Apps\Payment\Desjardins\Module\ClicShoppingAdmin\Config\ConfigParamAbstract {
    public $default = '0';
    public $sort_order = 500;

    protected function init()
    {
        $this->title = $this->app->getDef('cfg_desjardins_order_status_id_title');
        $this->description = $this->app->getDef('cfg_desjardins_order_status_id_desc');
    }
    ...
    public function getInputField()
    {
        $statuses_array = [
            [
                'id' => '0',
                'text' => $this->app->getDef('cfg_desjardins_order_status_id_default')
            ]
        ];
