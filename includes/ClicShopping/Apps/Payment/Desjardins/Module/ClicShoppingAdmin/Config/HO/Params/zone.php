...
class zone extends \ClicShopping\Apps\Payment\Desjardins\Module\ClicShoppingAdmin\Config\ConfigParamAbstract {
    public $default = '0';
    public $sort_order = 500;

    protected function init()
    {
        $this->title = $this->app->getDef('cfg_desjardins_zone_title');
        $this->description = $this->app->getDef('cfg_desjardins_zone_desc');
    }
    ...
    public function getInputField()
    {
        $zone_class_array = [
                              [
                                'id' => '0',
                                'text' => $this->app->getDef('cfg_desjardins_zone_global')
                              ]
                            ];
