 ...
 */
  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract {
    ...
    public function execute() {
      ...
      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_Desjardins->getDef('alert_module_uninstall_success'), 'success', 'Desjardins');
    ...
    private static function removeMenu() {
      ...
      if ($Qcheck->fetch()) {
        ...
        $QMenuId->bindValue(':app_code',  'app_payment_desjardins');
        $QMenuId->execute();
        ...
        $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_payment_desjardins']);
      }
    }
  }